...
import com.yws.plane.entity.TaskScheduleModel;
...
public class CronUtil {
    ...
    private static final SimpleDateFormat sdf2 = new SimpleDateFormat("ss mm HH dd MM ?");
    /**
     *
     *方法摘要：构建Cron表达式
...
//      Date startTime = taskScheduleModel.getScheduleStartTime();
    ...
    public static void main(String[] args) throws ParseException {
        ...
        System.out.println(getCron("2020-01-10 10:10:50"));
